...
function ChatsList() {
  const { getMyChatPartners, chats, isUsersLoading, selectedUser, setSelectedUser } = useChatStore();
        ...
        return (
          ...
          >
            <div className="relative shrink-0">
              <img src={chat.profilePic || "/avatar.png"} alt={chat.fullName} className="size-14 rounded-2xl object-cover border border-white/10" />
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <h3 className="truncate text-sm font-semibold text-white">{chat.fullName}</h3>
              ...
              <div className="mt-1 flex items-center gap-2">
                ...
                <p className="truncate text-xs text-slate-400">Start chatting...</p>
              </div>
            </div>
          </motion.button>
        );
